...
| --- | --- | --- | --- | --- |
| v0.3.0-rc.3 | Windows 11 x64, build 26200.8875 | 26.721.3996.0 | New-session Skill bootstrap, light/dark generation, offline validation, dark/light preview, verify, disable, manual click/input/scroll checks, readable dark/light menus, and invalid-manifest recovery | Maintainer verified on one machine on 2026-07-24 |
