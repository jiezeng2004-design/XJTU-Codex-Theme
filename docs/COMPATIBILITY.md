...
| --- | --- | --- | --- | --- |
| v0.3.0-rc.1 | Windows 11 x64, build 26200.8875 | 26.721.3996.0 | Engine dark/light preview, manual click/input/scroll checks, verify, disable and invalid-manifest recovery; new-session Skill E2E pending | Maintainer verified on one machine on 2026-07-24 |
